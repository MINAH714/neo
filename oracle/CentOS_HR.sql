...
select to_number('0123'), to_number('1234.5') from dual;
...
SELECT LENGTH('한글'), LENGTH('AB'), lengthb('한글'), LENGTH('AB') FROM dual;
...
SELECT months_between(sysdate, '2000-07-14') FROM dual;
