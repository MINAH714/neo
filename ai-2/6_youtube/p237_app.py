...
srt_formattered = srt_formatter.format_transcript(transcript)
print(srt_formattered[:150])
print('-' * 50)

text_formatter = TextFormatter()
text_formattered = text_formatter.format_transcript(transcript)
print(text_formattered[:150])
print('-' * 50)
